...
import { FaCss3, FaDocker, FaGithub, FaHtml5, FaInstagram, FaJava, FaJs, FaLaravel, FaLinkedin, FaMedium, FaNodeJs, FaPhp, FaReact, FaTwitter } from "react-icons/fa";
...
export const aboutMeData = () => {
	...
	const socials: { link: string, icon: IconType, style: string }[] = [
		{
			link: "https://www.linkedin.com/in/putu-gde-arya-bhanuartha-a65178248", style: "text-cyan-700 hover:text-cyan-900", icon: FaLinkedin
		},
		{
			icon: FaMedium, link: "https://medium.com/@putuaryabhanu03", style: "text-cyan-900 hover:text-black"
		},
		{
			icon: FaTwitter, link: "https://twitter.com/stackontheflow", style: "text-cyan-400 hover:text-cyan-500"
		},
		{
			icon: FaInstagram, link: "https://www.instagram.com/putu_arrtha", style: "text-cyan-700  hover:text-cyan-900"
		},
		{
			link: "https://github.com/putubhanuartha", icon: FaGithub, style: "text-cyan-900  hover:text-cyan-700"
		}];
	// skills tech
...
export const myExperienceData = () => {
	...
	const educations: CardDescriptionProps[] = [
		{ from: "August 2021", tag: "Bachelor of Information Systems", title: "Brawijaya University", valueDesc: "GPA: 3.88 / 4.00", linkFile: "/file/nilai.pdf", until: "Present" }
	];
	// Work & Teaching asisstant
	const workTeachings: CardDescriptionProps[] = [
		{
			from: "Oct 2023", tag: "Frontend Engineer Intern", title: "DOT Indonesia", valueDesc: "Description", listDescription: [
	...
	const organizationVolunteers: CardDescriptionProps[] = [
		{
			from: "Mar 2022", tag: "Homeband Division Staff, Experts Staff", title: "BIOS (Badan Internal Olahraga dan Seni) FILKOM UB", valueDesc: "Description", linkFile: "/file/staff_homeband.pdf", until: 'Feb 2023', listDescription: [
				"Band Manager",
...
export const portfolios: CardImageProps[] = [
	{
		...
		"linkRepo": [
			"https://github.com/putubhanuartha/gala-website-client"
		],
		"tag": "Next Js, React Js, Framer Motion",
		"title": "GALA 55 Concert Ticket Website",
		"linkDeployed": [
			"https://gala-website-client.vercel.app"
		],
	...
	},
	{
		...
		"linkRepo": [
			"https://github.com/putubhanuartha/website-desa-client"
		],
		"tag": "React Js, Framer Motion, Chart Js",
		"title": "Website Desa Sidorejo Client Application",
		"linkDeployed": [
			"https://website-desa-client-ashen.vercel.app"
		]
	},
	{
		...
		"linkRepo": [
			"https://github.com/putubhanuartha/pomodoro-app"
		],
	...
	},
	{
		...
		linkRepo: ["https://github.com/putubhanuartha/client-dot-quiz", "https://github.com/putubhanuartha/server-dot-quiz"],
		dockerDownload: {
			linkDownload: "https://drive.google.com/file/d/1oCW4Z73Kp8QHTilI899ikWwQ5CD-Fiva/view?usp=sharing",
			videoLink: "https://drive.google.com/file/d/1BisU8PNEVQYY8vwaTDTEkrfu0564F_hj/view?usp=sharing"
		}
	},
	{
		urlImage: "/portfolio/e-vote.png",
		linkRepo: ["https://github.com/putubhanuartha/e-vote-admin", "https://github.com/putubhanuartha/e-vote-warga", "https://github.com/putubhanuartha/e-vote-main-server"],
		tag: "Next Js, Node Js, MySQL",
		title: "Fullstack E-Vote Application",
		dockerDownload: {
			linkDownload: "https://drive.google.com/file/d/1lVQlOaD3tdurmK_iTspWXk7hEw3lNd9M/view?usp=sharing",
			videoLink: "https://drive.google.com/file/d/1BisU8PNEVQYY8vwaTDTEkrfu0564F_hj/view?usp=sharing"
		}
	}
